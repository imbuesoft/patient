...
const SpecialitiesSearch = () => {
  ...
  return (
    <div className="input-group">
      ...
      <input className="drSearch border-0 fs-5" value={input} onChange={(e) => setInput(e.target.value)} onClick={handleClick} placeholder="Search doctor, clinics, hospitals, etc."/>
