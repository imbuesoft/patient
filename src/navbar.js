            ...
            <nav className="navbar navbar-expand-sm ps-3 pe-3 " >
              ...
              <div className="collapse navbar-collapse" id="xyz">
                <div className="navbar-nav"  >
                  <Link to="/MyForm" className="navbar navbar-brand nav-link active" style={{color:'blue'}}><h1>DEV</h1></Link>
                  ...
                  <Link to="/Report" className="nav-link" style={{color:'white',marginTop:'10px',marginLeft:'10px'}}>Report</Link>
